...
namespace Rover656.Survivors.Common.Registries
{
    ...
    {
        public static GameSystemType DumbFollower { get; } = new(EnvironmentConstraint.HybridAny, 0);
        public static GameSystemType DistancedFollower { get; } = new(EnvironmentConstraint.HybridAny, 0);
        public static GameSystemType Damage { get; } = new(EnvironmentConstraint.HybridAny, 0);

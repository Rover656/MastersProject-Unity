...
namespace Rover656.Survivors.Framework
{
    ...
    public abstract class AbstractHybridGame<TGame> where TGame : AbstractHybridGame<TGame>
    {
        ...
        protected THybridSystem AddSystem<THybridSystem>(THybridSystem system) where THybridSystem : IHybridSystem<TGame>
        {
            _systems.Add(system);
            return system;
        }
        ...
        public void AddNewEntity<T>(T entity) where T : AbstractEntity<TGame>
        {
        ...
        protected virtual void OnEntityAdded(AbstractEntity<TGame> entity)
        {
        }

        protected virtual void OnEntityMoved(AbstractEntity<TGame> entity)
        {
        }
